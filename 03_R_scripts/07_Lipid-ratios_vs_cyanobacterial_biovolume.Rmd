---
title: "07-Lipid-ratios_vs_cyanobacterial-biovolume"
...
lipid_ratios <- read.csv ("C:\\Users\\KlattA\\OneDrive - Universität Basel\\Desktop\\Uni Basel\\Basel AG Ladd\\PhD project\\PhD thesis\\Chapter 1 ROT19\\Supplementary_C1\\Tables_C1\\Lipid_ratios_ROT19-02.csv", header = TRUE , sep = ";" , stringsAsFactors = FALSE, na.strings = "#NV")
...
phytoplankton_total.bioVol <- read.csv ("C:\\Users\\KlattA\\OneDrive - Universität Basel\\Desktop\\Uni Basel\\Basel AG Ladd\\PhD project\\PhD thesis\\Chapter 1 ROT19\\Supplementary_C1\\Tables_C1\\phyto_microplankton_biovolume_ROT19.csv", header = TRUE , sep = ";" , stringsAsFactors = FALSE, na.strings = "#NV")
...
pcyano_surface <- ggplot() + ggtitle("1 m depth", subtitle= "1 m depth")+
  ...
  geom_point(data=cyano_relBioA, aes(x=date,y=value), fill= "cyan4", shape= 23, size=3,alpha=0.8)+
...
pcyano_chlorMax <- ggplot() + ggtitle("chlorophyll maximum depth", subtitle= "chlorophyll maximum depth")+
  ...
  geom_point(data=cyano_relBioB, aes(x=date,y=value, fill= variable), shape= 23, size=3,alpha=0.8)+
...
Fig8 <- plot_grid(pcyano_lipid_ratio_surface, pcyano_lipid_ratio_chlorMax, ncol=2,rel_widths = c(1.05,1), align="h")
