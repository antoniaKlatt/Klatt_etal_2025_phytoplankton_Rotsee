---
title: "06_seasonal&annual_modeling_epsilon-Lipid1-Lipid2"
...
Avg.epsilon_lipid1.2 <- read.csv ("C:\\Users\\KlattA\\OneDrive - Universität Basel\\Desktop\\Uni Basel\\Basel AG Ladd\\PhD project\\PhD thesis\\Chapter 1 ROT19\\Supplementary_C1\\Tables_C1\\weighted_avg_epsilon_lipid1_lipid2_ROT19.csv",
                                  header = TRUE , sep = ";" , stringsAsFactors = FALSE, na.strings = "#NV")

## seasonal and yearly phytoplankton relative biovolume 

phytoplankton_Avg.rel.bioVol <- read.csv ("C:\\Users\\KlattA\\OneDrive - Universität Basel\\Desktop\\Uni Basel\\Basel AG Ladd\\PhD project\\PhD thesis\\Chapter 1 ROT19\\Supplementary_C1\\Tables_C1\\weighted_avg_phytoplankton_biovolume_ROT19.csv", header = TRUE , sep = ";" , stringsAsFactors = FALSE, na.strings = "#NV")

## seasonal and yearly phytoplankton & microzooplankton relative biovolume 

phyto.microplankton_Avg.rel.bioVol <- read.csv ("C:\\Users\\KlattA\\OneDrive - Universität Basel\\Desktop\\Uni Basel\\Basel AG Ladd\\PhD project\\PhD thesis\\Chapter 1 ROT19\\Supplementary_C1\\Tables_C1\\weighted_avg_phyto_microplankton_biovolume_ROT19.csv", header = TRUE , sep = ";" , stringsAsFactors = FALSE, na.strings = "#NV")

## seasonal and yearly eukaryotic algae relative biovolume 

eukary.algae_Avg.rel.bioVol <- read.csv ("C:\\Users\\KlattA\\OneDrive - Universität Basel\\Desktop\\Uni Basel\\Basel AG Ladd\\PhD project\\PhD thesis\\Chapter 1 ROT19\\Supplementary_C1\\Tables_C1\\weighted_avg_eukaryotic_algae_biovolume_ROT19.csv", header = TRUE , sep = ";" , stringsAsFactors = FALSE, na.strings = "#NV")

## seasonal and yearly eukaryotic algae & microzooplankton relative biovolume 

eukary.algae.microplankton_Avg.rel.bioVol <- read.csv ("C:\\Users\\KlattA\\OneDrive - Universität Basel\\Desktop\\Uni Basel\\Basel AG Ladd\\PhD project\\PhD thesis\\Chapter 1 ROT19\\Supplementary_C1\\Tables_C1\\weighted_avg_eukaryotic_algae_microplankton_biovolume_ROT19.csv", header = TRUE , sep = ";" , stringsAsFactors = FALSE, na.strings = "#NV")

## seasonal and yearly d2H water values

Avg.d2H.water <- read.csv ("C:\\Users\\KlattA\\OneDrive - Universität Basel\\Desktop\\Uni Basel\\Basel AG Ladd\\PhD project\\PhD thesis\\Chapter 1 ROT19\\Supplementary_C1\\Tables_C1\\avg_d2H_H2O_ROT19.csv", header = TRUE , sep = ";" , stringsAsFactors = FALSE, na.strings = "#NV")
...
alpha_lipid_cultures <- read.csv ("C:\\Users\\KlattA\\OneDrive - Universität Basel\\Desktop\\Uni Basel\\Basel AG Ladd\\PhD project\\PhD thesis\\Chapter 1 ROT19\\Supplementary_C1\\Tables_C1\\alpha_lipid_water_algae_cultures_Ladd_etal_2024.csv",
                                  header = TRUE , sep = ";" , stringsAsFactors = FALSE, na.strings = "#NV")


## d2H C16:0 values from seston and zooplankton (Pilecky et al., 2022) [https://doi.org/10.1111/1365-2435.13981]

d2H_C16.0_seston_zoo <- read.csv ("C:\\Users\\KlattA\\OneDrive - Universität Basel\\Desktop\\Uni Basel\\Basel AG Ladd\\PhD project\\PhD thesis\\Chapter 1 ROT19\\Supplementary_C1\\Tables_C1\\d2H_C16.0_FieldStudy_Pilecky_etal_2022.csv",
                                  header = TRUE , sep = ";" , stringsAsFactors = FALSE, na.strings = "#NV")
...
pAvg.Eps_C16.0_phytol <- ggplot() + 
  ...
  geom_errorbar(data= Avg.eps_lipid1.2_modeled_mix[5:5,1:2], 
                aes(x=5.275, y=mean_eps_C16_phytol_mix ,xmin=5.275, xmax=5.275, 
                    ymin=(mean_eps_C16_phytol_mix-sd_eps_C16_phytol_mix),
                    ymax=(mean_eps_C16_phytol_mix+sd_eps_C16_phytol_mix)), color="turquoise3", width=0.25)+
  annotate("text",x=-1.9,y=387,label="A", size=15, fontface=2, color="black")+
  annotate("text",x=-0.5,y=387,label="2019-2020", size=10.75,color="black")+
  annotate("text",x=1,y=387,label="2019", size=10.75,color="black")+
  annotate("text",x=2,y=387,label="2019", size=10.75,color="black")+
  annotate("text",x=3,y=387,label="2019", size=10.75,color="black")+
  annotate("text",x=4,y=387, label="2019", size=10.75,color="black")+
  annotate("text",x=5,y=387,label="2020", size=10.75,color="black")+
  coord_cartesian(xlim=c(-1,5.25), ylim=c(175,375), clip="off")+
  scale_y_continuous(breaks=c(200,250,300,350))+
  ...
  theme(axis.line.y = element_line(colour = "black"),
        ...
        axis.title.y = element_text(size=45, color="navy"),
        legend.position = "right",
        strip.background = element_blank(),
        strip.placement = "outside",
        strip.text = element_blank(),
        plot.margin = unit(c(1.15,0.25,0,0.75), "cm"))+
...
pAvg.Eps_C16.0_sterol <- ggplot() + 
  ...
  geom_errorbar(data= Avg.eps_lipid1.2_modeled_mix[5:5,3:4], 
                aes(x=5.275, y=mean_eps_C16_sterol_mix ,xmin=5.275, xmax=5.275, 
                    ymin=(mean_eps_C16_sterol_mix-sd_eps_C16_sterol_mix),
                    ymax=(mean_eps_C16_sterol_mix+sd_eps_C16_sterol_mix)), color="plum3", width=0.25)+
  annotate("text",x=-1.9,y=185,label="B", size=15, fontface=2, color="black")+
  coord_cartesian(xlim=c(-1,5.25), ylim=c(-25,175),clip="off")+
  ...
  theme(axis.line.y = element_line(colour = "black"),
        ...
        axis.ticks.x= element_blank(),
        axis.title.x = element_blank(),
        axis.title.y = element_text(size=45, color="violetred"),
        legend.position = "right",
        strip.background = element_blank(),
        strip.placement = "outside",
        strip.text = element_blank(),
        plot.margin = unit(c(0.15,0.25,0,0.75), "cm"))+
  guides(fill = guide_legend(byrow = TRUE))
...
pAvg.Eps_sterol_phytol <- ggplot() + 
  ...
  geom_errorbar(data= Avg.eps_lipid1.2_modeled_mix[5:5,5:6], 
                aes(x=5.275, y=mean_eps_sterol_phytol_mix ,xmin=5.275, xmax=5.275, 
                    ymin=(mean_eps_sterol_phytol_mix-sd_eps_sterol_phytol_mix),
                    ymax=(mean_eps_sterol_phytol_mix+sd_eps_sterol_phytol_mix)), color="yellow3", width=0.25)+
  annotate("text",x=-0.5,y=77.5,label="year", size=12,color="black", fontface="bold")+
  annotate("text",x=1,y=77.5,label="winter", size=12,color="black", fontface="bold")+
  annotate("text",x=2,y=77.5,label="spring", size=12,color="black", fontface="bold")+
  annotate("text",x=3,y=77.5,label="summer", size=12,color="black", fontface="bold")+
  annotate("text",x=4,y=77.5,label="autumn", size=12,color="black", fontface="bold")+
  annotate("text",x=5,y=77.5,label="winter", size=12,color="black", fontface="bold")+
  annotate("text",x=-1.9,y=310, label="C", size=15, fontface=2, color="black")+
  coord_cartesian(xlim=c(-1,5.25),ylim=c(100,300),clip="off")+
  scale_y_continuous(breaks=c(125,175,225,275))+
  guides(shape = guide_legend(order=1))+
  theme(axis.line.y = element_line(colour = "black"), 
        ...
        axis.title.x = element_blank(),
        axis.title.y = element_text(size=45, color="springgreen4"),
        legend.position = "right",
        strip.background = element_blank(),
        strip.placement = "outside",
        strip.text = element_blank(),
        plot.margin = unit(c(0.15,0.25,2.35,0.75), "cm"))+
  guides(fill = guide_legend(byrow = TRUE))

Fig7 <- plot_grid(pAvg.Eps_C16.0_phytol, pAvg.Eps_C16.0_sterol, pAvg.Eps_sterol_phytol,
          ncol=1, align="v", rel_heights = c(1.155,1.055,1.2)) 
