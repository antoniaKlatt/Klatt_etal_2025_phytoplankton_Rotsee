---
title: "01-Temperature & Dissolved Oxygen Profile"
...
Temp_Ox_ROT190410 <- read.csv ("C:\\Users\\KlattA\\OneDrive - Universität Basel\\Desktop\\Uni Basel\\Basel AG Ladd\\PhD project\\PhD thesis\\Chapter 1 ROT19\\Supplementary_C1\\Tables_C1\\temp_oxygen_profile_watercolumn_ROT190410.csv", header = TRUE , sep = ";" , stringsAsFactors = FALSE, na.strings = "#NV")

Temp_Ox_ROT190717 <- read.csv ("C:\\Users\\KlattA\\OneDrive - Universität Basel\\Desktop\\Uni Basel\\Basel AG Ladd\\PhD project\\PhD thesis\\Chapter 1 ROT19\\Supplementary_C1\\Tables_C1\\temp_oxygen_profile_watercolumn_ROT190717.csv", header = TRUE , sep = ";" , stringsAsFactors = FALSE, na.strings = "#NV")

Temp_Ox_ROT190925 <- read.csv ("C:\\Users\\KlattA\\OneDrive - Universität Basel\\Desktop\\Uni Basel\\Basel AG Ladd\\PhD project\\PhD thesis\\Chapter 1 ROT19\\Supplementary_C1\\Tables_C1\\temp_oxygen_profile_watercolumn_ROT190925.csv", header = TRUE , sep = ";" , stringsAsFactors = FALSE, na.strings = "#NV")

Temp_Ox_ROT191023 <- read.csv ("C:\\Users\\KlattA\\OneDrive - Universität Basel\\Desktop\\Uni Basel\\Basel AG Ladd\\PhD project\\PhD thesis\\Chapter 1 ROT19\\Supplementary_C1\\Tables_C1\\temp_oxygen_profile_watercolumn_ROT191023.csv", header = TRUE , sep = ";" , stringsAsFactors = FALSE, na.strings = "#NV")

Temp_Ox_ROT191218 <- read.csv ("C:\\Users\\KlattA\\OneDrive - Universität Basel\\Desktop\\Uni Basel\\Basel AG Ladd\\PhD project\\PhD thesis\\Chapter 1 ROT19\\Supplementary_C1\\Tables_C1\\temp_oxygen_profile_watercolumn_ROT191218.csv", header = TRUE , sep = ";" , stringsAsFactors = FALSE, na.strings = "#NV")
...
Fig2 <- plot_grid(pSpring, pSummer, pAutumn1, pAutumn2, pWinter, ncol=5, align= "h", rel_widths = c(1.2,0.95,1.1,1,1.15))
