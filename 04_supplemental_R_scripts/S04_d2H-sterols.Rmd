...
d2H_H2O_lipids <- read.csv ("C:\\Users\\KlattA\\OneDrive - Universität Basel\\Desktop\\Uni Basel\\Basel AG Ladd\\PhD project\\PhD thesis\\Chapter 1 ROT19\\Supplementary_C1\\Tables_C1\\d2H_H2O_lipids_ROT19.csv", header = TRUE , sep = ";" , stringsAsFactors = FALSE, na.strings = "#NV")
...
FigS4 <- plot_grid(pd2H_surface2, pd2H_chlorMax2, ncol=2,rel_widths = c(1,0.95), align="h")
