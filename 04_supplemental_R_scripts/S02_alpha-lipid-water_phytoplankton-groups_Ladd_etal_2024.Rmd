---
title: "S02_alpha-lipid-water_phytoplankton-groups"
...
## alpha lipid/water values algal culturing studies

#Ladd, et al. (2024): Taxon-specific hydrogen isotope signals in cultures and mesocosms facilitate ecosystem and hydroclimate reconstruction. doi: https://doi.org/10.31223/X57T30 
...
norm_C16_phyto <-ggplot(df_C16_norm_group) +
  ...
  scale_fill_manual(labels=c(cyano="Cyanophyceae", GA= "Chlorophyceae", chryso= "Chrysophyceae", 
                    ...
                    values= c(cyano="cyan4", GA="forestgreen", chryso="darkgoldenrod1",
                              dia= "blue" ,dino= "magenta", crypto= "gray56"),
                    name= "phytoplankton group",
                    breaks= c("dia", "GA", "chryso","crypto", "cyano", "dino"))+
  xlab(expression(alpha^{2}*""['C16:0/water']~("\211")))+ylab("density")+
  coord_cartesian(xlim=c(0.6,1.1), ylim=c(0,27),clip="off")+
  scale_y_continuous(breaks=c(5,10,15,20,25))+
  annotate("text",y= 27, x= 0.6,label="A", size=15, fontface=2, color="black")+
...
norm_sterol_phyto <-ggplot(df_sterol_norm_group) +
  ...
  coord_cartesian(xlim=c(0.5,1), ylim=c(0,27),clip="off")+
  scale_y_continuous(breaks=c(5,10,15,20,25))+
  annotate("text",y= 27, x= 0.5,label="B", size=15, fontface=2, color="black")+
  theme(axis.line = element_line(colour = "black"),
        legend.position="none",
        panel.background = element_blank(),
        panel.border = element_blank(),
...
norm_phytol_phyto <-ggplot(df_phytol_norm_group) +
  ...
  coord_cartesian(xlim=c(0.4,0.9), ylim=c(0,27),clip="off")+
  scale_y_continuous(breaks=c(5,10,15,20,25))+
...
FigS2 <- plot_grid(norm_C16_phyto, norm_sterol_phyto, norm_phytol_phyto, ncol=3, align="h", rel_widths = c(1,0.95,1.45))
